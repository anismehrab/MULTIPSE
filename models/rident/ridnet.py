...
from models.rident import common,ops
...
class RIDNET(nn.Module):
    def __init__(self, nf = 64,img_range=1):
        ...
        self.head = ops.BasicBlock(3, nf, kernel_size, 1, 1)
        ...
        self.tail = nn.Conv2d(nf, 3, kernel_size, 1, 1, 1)
