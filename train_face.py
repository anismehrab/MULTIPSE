...
parser.add_argument("--use_tail", type=bool, default=False,help="downsampler model")
parser.add_argument("--resize", type=int, default=64,help="super-resolution scale")
...
#load models
print("loading model")
tail_model = None#model.DownSampler_x4()
