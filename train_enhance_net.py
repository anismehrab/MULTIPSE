...
parser.add_argument("--checkpoint_path", type=str, default="checkpoints/enhance_net_checkpoints/enhance_net_x3/v2",help="checkpoint_folder_path")
parser.add_argument("--logger_path", type=str, default="checkpoints/enhance_net_checkpoints/enhance_net_x3/v2/train_logging.log",help="logger path")
...
parser.add_argument("--max_dim", type=int, default=350,help="max image dimension")
parser.add_argument("--min_dim", type=int, default=128,help="min image dimension")
parser.add_argument("--max_cells", type=int, default=130*130,help="min image dimension")#x3 250*250
...
def reInitLoader(box):
    ...
    dataBatch = DataBatch(transfrom=batch_compos,scale =args.scale ,max_box = box,max_cells= args.max_cells,devider=2,force_size=None,use_same= False,use_inter=False)
...
#load models
print("loading model")
model = enhance_model.EnhanceNetX3() #enhance_model.EnhanceNet(upscale=args.scale)
