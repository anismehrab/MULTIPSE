...
parser.add_argument("--checkpoint_path", type=str, default="checkpoints/enhance_net_checkpoints/enhance_net_x3",help="checkpoint_folder_path")
parser.add_argument("--logger_path", type=str, default="checkpoints/enhance_net_checkpoints/enhance_net_x3/train_logging.log",help="logger path")
...
def reInitLoader(box):
    ...
    dataBatch = DataBatch(transfrom=batch_compos,scale =args.scale ,max_box = box,max_cells= args.max_cells,devider=1,force_size=None,use_same=False)
...
#load models
print("loading model")
model = enhance_model.EnhanceNetX3() #enhance_model.EnhanceNetSame() 
