...
parser.add_argument("--checkpoint_path", type=str, default="checkpoints/enhance_net_checkpoints/enhance_net_x2/v2",help="checkpoint_folder_path")
parser.add_argument("--logger_path", type=str, default="checkpoints/enhance_net_checkpoints/enhance_net_x2/v2/train_logging.log",help="logger path")
...
parser.add_argument("--max_cells", type=int, default=180*180,help="min image dimension")
...
#load models
print("loading model")
model = enhance_model.EnhanceNetX2_v2() #enhance_model.EnhanceNet(upscale=args.scale)
