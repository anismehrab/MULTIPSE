...
parser.add_argument("--checkpoint_path", type=str, default="checkpoints/enhance_net_checkpoints",help="checkpoint_folder_path")
parser.add_argument("--logger_path", type=str, default="checkpoints/enhance_net_checkpoints/train_logging.log",help="logger path")
...
parser.add_argument("--max_cells", type=int, default=256*256,help="min image dimension")
...
def reInitLoader(box):
    ...
    dataBatch = DataBatch(transfrom=batch_compos,scale =args.scale ,max_box = box,max_cells= args.max_cells,devider=args.scale)
