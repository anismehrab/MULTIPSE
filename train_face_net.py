...
parser.add_argument("--checkpoint_path", type=str, default="checkpoints/face_net_checkpoints",help="checkpoint_folder_path")
parser.add_argument("--logger_path", type=str, default="checkpoints/face_net_checkpoints/face_net_train_logging.log",help="logger path")
...
def reInitLoader(box):
    ...
    batch_compos = transforms.Compose([AddMaskFace(),FaceNormalize(),FaceToTensor()])
